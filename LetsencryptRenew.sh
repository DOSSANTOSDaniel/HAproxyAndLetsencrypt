...
#            :  Ce script sera lancé tous les deux mois le 20 à 19h:30.
#            :  L'option renew --force-renewal permet de forcer le renouvellement des certificats,
#            :  même si les certificats sont encore actifs.
#            :                                                                                      
...
/usr/bin/certbot renew --force-renewal | /usr/bin/logger -t HaproxyRenew
